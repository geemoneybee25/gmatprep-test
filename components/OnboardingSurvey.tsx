...
const BellCurveSection: React.FC<{
  ...
  // GMAT Focus Edition total score 205-805:
  const ranges = [
    { id: 'p50', label: '205 - 515', percentile: '50th & Below', startX: 0, endX: 200 },
    { id: 'p65', label: '515 - 575', percentile: '50th - 65th', startX: 200, endX: 240 },
    { id: 'p80', label: '575 - 635', percentile: '65th - 80th', startX: 240, endX: 280 },
    { id: 'p90', label: '635 - 695', percentile: '80th - 90th', startX: 280, endX: 320 },
    { id: 'p95', label: '695 - 755', percentile: '90th - 95th', startX: 320, endX: 360 },
    { id: 'p99', label: '755 - 805', percentile: '95th - 99th+', startX: 360, endX: 400 },
  ];
    ...
    <div className="animate-in fade-in slide-in-from-right-4 duration-500">
      ...
      <div className="relative mb-12 px-4">
        ...
        <div className="flex justify-between mt-4 px-1">
          <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">205</span>
          <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">515 (Avg)</span>
          <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">805</span>
        </div>
      </div>
